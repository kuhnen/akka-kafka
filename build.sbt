...
libraryDependencies += "com.typesafe.akka" %% "akka-actor" % "2.3.7" % "compile"

libraryDependencies += "com.typesafe.akka" %% "akka-slf4j" % "2.3.7" % "test,it"

libraryDependencies +=   "org.apache.kafka" %% "kafka"  %"0.8.2-beta" exclude("log4j", "log4j") exclude("org.slf4j","slf4j-log4j12")

libraryDependencies += "com.typesafe.akka" %% "akka-testkit" % "2.3.7" % "test,it"
